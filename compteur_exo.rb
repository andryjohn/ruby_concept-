...
=begin 
*reer un hash pour stocker les mots
*Obtenir un tableau des mots de notre texte (split())voir la doc 
*Iterer sur me tableau précédent 
*Remplir les information 

**organiser les mots pour sortir es mots les plus fréquent 
=end
